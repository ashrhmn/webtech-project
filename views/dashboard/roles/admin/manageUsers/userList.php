...
<table>
	...
	?>
		<tr class="<?= ($i % 2 == 0) ? 'evenRow' : 'oddRow' ?>">
			...
			<td>
				<a class="btnAction" href="<?= "roles/admin/manageUsers/editUser.php?id=" . $allUsers[$i]['id'] ?>">
				...
				<a class="btnAction" href="<?= "/app/controllers/admin/deleteUser.php?id=" . $allUsers[$i]['id'] ?>">
					<svg xmlns="http://www.w3.org/2000/svg" class="actionSvg delBtn" viewBox="0 0 20 20" fill="currentColor">
